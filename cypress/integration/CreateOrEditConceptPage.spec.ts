...
//   createDictionary,
//   TestDictionary
// } from "../../src/apps/dictionaries/pages/tests/e2e/testUtils";
...
//     .type(item.search);
//   cy.find('#asyncSelectResultsList')
//     .find(`[text=${item.select}]`)
//     .should("be.visible")
//     .click();
// }

// export function fillNameRow(index: number, concept: TestConcept) {
//   cy.find(`#names_${index}_name`).type(concept.names[index].name);
//   cy.selectBySelector(
...
// describe("Create or Edit Concept Page", () => {
